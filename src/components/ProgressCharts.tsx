    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
        <div className="glass rounded-xl p-3 sm:p-4 border border-white/10">
          ...
          <p className="text-[10px] text-muted-foreground">per savaitę</p>
        </div>
        
        <div className="glass rounded-xl p-3 sm:p-4 border border-white/10">
          <div className="flex items-center gap-2 mb-2">
            <BookOpen className="w-4 h-4 text-purple-400" />
            <span className="text-[10px] sm:text-xs text-muted-foreground">Sesijos</span>
          </div>
          <p className="text-lg sm:text-xl font-bold text-foreground">{totalSessions}</p>
          <p className="text-[10px] text-muted-foreground">per savaitę</p>
        </div>
        ...
        <div className="glass rounded-xl p-3 sm:p-4 border border-white/10">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[10px] sm:text-xs text-muted-foreground">Vidurkis</span>
          </div>
          <p className="text-lg sm:text-xl font-bold text-foreground">
            {totalSessions > 0 ? Math.round(totalWeeklyMinutes / totalSessions) : 0}m
          </p>
          <p className="text-[10px] text-muted-foreground">per sesiją</p>
        </div>
        
        <div className="glass rounded-xl p-3 sm:p-4 border border-white/10">
          <div className="flex items-center gap-2 mb-2">
            <Target className="w-4 h-4 text-orange-400" />
            <span className="text-[10px] sm:text-xs text-muted-foreground">Progresas</span>
          </div>
          <p className="text-lg sm:text-xl font-bold text-foreground">
            {subjects.length > 0 
          ...
          <p className="text-[10px] text-muted-foreground">bendras</p>
        </div>
      </div>
